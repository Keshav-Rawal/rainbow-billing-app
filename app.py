    ...
    if role == "SUPERADMIN":
        ...
        # ==========================================
            ...
            if st.button("🚀 Save & Print Challan", type="primary", key="save_print_btn"):
                ...
                .spacer-row td {{ height: 80px; border-top: none; border-bottom: none; }} 
