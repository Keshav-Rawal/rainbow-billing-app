...
if not st.session_state.logged_in:
    st.title("🔒 Rainbow Industries - Billing System")
    
    # Screen ke beech mein box banane ke liye columns ka use kiya hai
    ...
    with login_col:
        ...
        login_submit = st.button("Login & Open System", type="primary", use_container_width=True)
        
        if login_submit:
            # Yahan aap apna manpasand Username aur Password change kar sakte hain
...
# --- 2. Main App Screen (Sirf Login hone ke baad dikhega) ---
else:
    # Sidebar mein ek Logout button de diya hai convenience ke liye
